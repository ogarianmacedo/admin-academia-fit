...
{
    public partial class adminAcademiaD : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CatExercicioId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    Nome = table.Column<string>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoriasExercicios", x => x.CatExercicioId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Exercicios_CategoriasExercicios_CatExercicioId",
                        column: x => x.CatExercicioId,
                        principalTable: "CategoriasExercicios",
                        principalColumn: "CatExercicioId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Exercicios_CatExercicioId",
                table: "Exercicios",
                column: "CatExercicioId");
